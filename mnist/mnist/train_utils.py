...
def setup_trainer(config, trial_mode=False, profiler=None):
    ...
    # Logger
    experiment_name = f"MNIST_CNN_{config['trainer']['max_epochs']}epochs"
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename="MNIST_CNN_epoch={epoch:02d}_val_loss={val_loss:.4f}"  # Custom filename format
    )
    ...
    trainer_args = {
        "max_epochs": 1 if trial_mode else config["trainer"]["max_epochs"],
